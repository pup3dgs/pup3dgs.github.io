...
Website source for [PUP 3D-GS](https://pup3dgs.github.io/).
...
**Favicon.** Shiba inu icon created by [smalllikeart](https://www.flaticon.com/free-icon/shiba-inu_4600417) on Flaticon.
...
- **Purged Bulma.** Only the rules this page actually uses are shipped — 12 KB of the
...
- **Self-hosted, subset fonts.** Noto Sans is served as a variable font subset from this repo
  ...
  rule.
- **Media loaded on demand.** Video sources and poster frames are held in `data-` attributes
  and promoted when they are wanted, so a reader who never scrolls past the abstract does not
  pay for the results.
